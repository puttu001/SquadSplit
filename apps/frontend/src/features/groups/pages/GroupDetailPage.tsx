        ...
        <div className="overflow-y-auto flex-1 p-5 flex flex-col gap-5">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <button
                onClick={copy}
                className="flex-1 bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 rounded-xl transition-colors flex items-center justify-center gap-2 text-sm"
              >
              ...
              <a
                href={`https://wa.me/?text=${encodeURIComponent(`Join my group on SquadSplit!\n${link}`)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-semibold text-sm text-white transition-colors"
