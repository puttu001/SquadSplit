    ...
    <>
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-5">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <h1 className="text-2xl font-bold text-gray-900 mr-2">Groups</h1>
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-2 bg-teal-600 hover:bg-teal-700 active:bg-teal-800 text-white text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors shadow-sm shadow-teal-600/25"
          >
